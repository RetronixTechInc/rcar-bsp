...
git checkout -b tmp 7bf79e5a67a024f64a88d5105269d8db95c4a216
git clone https://github.com/RetronixTechInc/meta-rtx-arm.git -b scarthgap meta-rtx

MACHINE_CONF="meta-rtx/conf/machine/$1.conf"

# modify kernel recipe for sdk3p44
KERNEL_BRANCH='"v4h-sbc\/v5.10.235\/rcar-5.2.4.rc1"'
...
# modify uboot recipe for sdk3p44
UBOOT_BRANCH='"v4h-sbc\/v2022.01\/rcar-6.0.0.rc13"'
...
"all" | "sparrowhawk")
    ...
    ;;
*)
    echo "Provide board name. Supported boards: sparrowhawk."
    exit -1
    ;;
esac
...
if [ $BOARD = "all" ]; then
    build_function sparrowhawk $OPTION
else
